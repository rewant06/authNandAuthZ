...
const ServicesPage = () => {
  return (
    <div className="min-h-screen relative">
      ...
      <div className="absolute top-40 left-10 w-72 h-72 bg-accent/20 rounded-full blur-3xl animate-float -z-10" style={{ animationDelay: "1.5s" }} />
        ...
        <div className="container mx-auto px-4 mb-16 md:mb-24">
          <div className="text-center max-w-4xl mx-auto animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed mb-8">
              From the first line of code to the final pixel, 

[Image of software development lifecycle]
 we provide a comprehensive suite of free services designed to scale with your vision.
            </p>
